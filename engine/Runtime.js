...
class Runtime {
	 ...
	 * @param {string} config.renderer.fontFamily A string CSS `font-family` value that will be used for text displayed in the renderer. Defaults to `"monospace"`. Monospaced fonts work best.
	 ...
	 * @returns {Runtime} The current `Runtime` instance.
	 */
	start(onInitialized) {
		this.running = true;
